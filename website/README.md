...
`https://github.com/ramcc007/morning-alarm-app/releases/download/debug-latest/wakerep.apk`
...
- [ ] Update `support@wakerep.app` and any other placeholder contact/domain references to your real domain and inbox.
